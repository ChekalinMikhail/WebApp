...
public class UserHandler {
    ...
    public void register(HttpServletRequest req, HttpServletResponse resp) {
        try {
            ...
            final var responceDto = service.register(requestDto);
            resp.setHeader("Content-Type", "application/json");
            resp.getWriter().write(gson.toJson(responceDto));
        } catch (IOException e) {
    ...
    public void login(HttpServletRequest req, HttpServletResponse resp) {
        try {
            ...
            final var responceDto = service.login(requestDto);
            resp.setHeader("Content-Type", "application/json");
            resp.getWriter().write(gson.toJson(responceDto));
        } catch (IOException e) {
            throw new RuntimeException(e);
    ...
    public void passwordRecoveryInquiry(HttpServletRequest req, HttpServletResponse resp) {
        final var userName = UserHelper.getUsername(req);
